...
class AwesomeNotificationsHelper {
  ...
  static listenToActionButtons() {
    ...
    awesomeNotifications.actionStream
        .listen(NotificationController.onActionReceivedMethod);
    awesomeNotifications.createdStream
        .listen(NotificationController.onNotificationCreatedMethod);
    awesomeNotifications.displayedStream
        .listen(NotificationController.onNotificationDisplayedMethod);
    awesomeNotifications.dismissedStream
        .listen(NotificationController.onDismissActionReceivedMethod);
  }
